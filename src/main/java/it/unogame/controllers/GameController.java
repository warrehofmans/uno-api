...
import it.unogame.model.CardCheck;
...
public class GameController {
    ...
    @PostMapping("/check")
    public ResponseEntity<boolean[]> checkRules(@RequestBody CardCheck cards) {
        return new ResponseEntity<>(this.rules.canCardsBePlayed(cards.getCard(), cards.getCards()), HttpStatus.OK);
    }
